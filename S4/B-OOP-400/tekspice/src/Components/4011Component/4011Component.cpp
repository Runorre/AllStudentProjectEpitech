...
nts::quatreMilleOnzeComponent::quatreMilleOnzeComponent(std::string name) : AComponent(name), state(4) {
...
nts::quatreMilleOnzeComponent::~quatreMilleOnzeComponent() {}

nts::Tristate nts::quatreMilleOnzeComponent::compute(std::size_t pin) {
    if (pin == 1 || pin == 2)
...
void nts::quatreMilleOnzeComponent::simulate(std::size_t tick) {
    (void) tick;
...
void nts::quatreMilleOnzeComponent::changeState(std::size_t pin, nts::Tristate newState) {
     if (pin == 3)
