...
nts::quatreMilleQutreVingtUnComponent::quatreMilleQutreVingtUnComponent(std::string name) : AComponent(name), state(4) {
...
nts::quatreMilleQutreVingtUnComponent::~quatreMilleQutreVingtUnComponent() {}

nts::Tristate nts::quatreMilleQutreVingtUnComponent::compute(std::size_t pin) {
    if (pin == 1 || pin == 2)
...
void nts::quatreMilleQutreVingtUnComponent::simulate(std::size_t tick) {
    (void) tick;
    ...
    else if (pin5 == nts::True || pin6 == nts::True) {
        if (pin5 == nts::Undefined || pin6 == nts::Undefined) {
    ...
    else if (pin13 == nts::True || pin12 == nts::True) {
        if (pin13 == nts::Undefined || pin12 == nts::Undefined) {
    ...
    else if (pin9 == nts::True || pin8 == nts::True) {
        if (pin9 == nts::Undefined || pin8 == nts::Undefined) {
...
void nts::quatreMilleQutreVingtUnComponent::changeState(std::size_t pin, nts::Tristate newState) {
     if (pin == 3)
