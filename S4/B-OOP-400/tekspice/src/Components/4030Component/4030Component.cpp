...
nts::quatreMilleTrenteComponent::quatreMilleTrenteComponent(std::string name) : AComponent(name), state(4) {
...
nts::quatreMilleTrenteComponent::~quatreMilleTrenteComponent() {}

nts::Tristate nts::quatreMilleTrenteComponent::compute(std::size_t pin) {
    if (pin == 1 || pin == 2)
...
void nts::quatreMilleTrenteComponent::simulate(std::size_t tick) {
    (void) tick;
...
void nts::quatreMilleTrenteComponent::changeState(std::size_t pin, nts::Tristate newState) {
     if (pin == 3)
