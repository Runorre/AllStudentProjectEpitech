...
nts::quatreMilleUnComponent::quatreMilleUnComponent(std::string name) : AComponent(name), state(4) {
...
nts::quatreMilleUnComponent::~quatreMilleUnComponent() {}

nts::Tristate nts::quatreMilleUnComponent::compute(std::size_t pin) {
    if (pin == 1 || pin == 2)
...
void nts::quatreMilleUnComponent::simulate(std::size_t tick) {
    (void) tick;
...
void nts::quatreMilleUnComponent::changeState(std::size_t pin, nts::Tristate newState) {
     if (pin == 3)
